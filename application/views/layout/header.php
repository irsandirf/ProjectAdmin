                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="<?=base_url('assets/')?>/assets/images/logotext.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo text -->
                            <img src="<?=base_url('assets/')?>/assets/images/logotext.png" class="light-logo" alt="homepage" />
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                        href="<?= site_url('Paketwisata/') ?>" aria-expanded="false"><i class="mdi mdi-file"></i><span
                                    class="hide-menu">Paket Wisata</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                        href="<?= site_url('Pemesanan/') ?>" aria-expanded="false"><i class="mdi mdi-border-all"></i><span
